            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              {navLinks.map((link) => (
                <li key={link.id}>
                  <NavLink
                    to={link.url}
                    className={({ isActive }) => (isActive ? "text-blue-900" : "hover:text-blue-900")}
                  >
                    {link.name}
                  </NavLink>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              ...
              <li>
                <Link
                  target="_blank"
                  to="https://www.tiktok.com/@devnis.web"
                  className="hover:text-blue-900 transition-colors"
                >
                  Tiktok
                </Link>
              ...
              <li>
                <Link
                  target="_blank"
                  to="https://www.instagram.com/devnis.web/"
                  className="hover:text-blue-900 transition-colors"
                >
                  Instagram
                </Link>
              ...
              <li>
                <Link
                  target="_blank"
                  to="https://www.facebook.com/profile.php?id=61585763949987"
                  className="hover:text-blue-900 transition-colors"
                >
                  Facebook
                </Link>
