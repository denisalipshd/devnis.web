  ...
  return (
    <>
      <SEO
        ...
        description="Layanan pembuatan website company profile, toko online, landing page, dan web custom."
        canonical="https://devnis-web.vercel.app/services"
        keywords="jasa website company profile, jasa toko online, jasa landing page"
      />
      <div>
        <header className="pt-48 pb-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8">
              Solusi Digital <span className="text-blue-900">Tanpa Kompromi.</span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group p-10 bg-white border border-gray-100 rounded-3xl hover:shadow-2xl hover:shadow-blue-600/5 transition-all duration-500">
                <div className="mb-8 p-4 bg-blue-50 w-fit rounded-2xl group-hover:bg-blue-600 transition-colors duration-500">
                  <svg
                    className="w-8 h-8 text-blue-900 group-hover:text-white"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <p className="text-gray-500 leading-relaxed mb-8">
                  Membangun ekosistem web yang scalable menggunakan teknologi terbaru seperti React, Laravel, dan
                  Node.js.
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col hover:shadow-xl transition-all duration-300">
                <h4 className="text-blue-900 font-bold uppercase tracking-widest text-xs mb-4">Starter</h4>
                ...
                <p className="text-gray-500 mb-8 text-sm">
                  Ideal untuk profil pribadi atau landing page produk tunggal.
                </p>
                ...
                <Link
                  ...
                  className="block text-center py-4 border border-blue-600 text-blue-900 rounded-xl font-bold hover:bg-blue-600 hover:text-white transition-all"
                >
                  Pilih Paket
                </Link>
              </div>
              ...
              <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col hover:shadow-xl transition-all duration-300">
                <h4 className="text-blue-900 font-bold uppercase tracking-widest text-xs mb-4">Custom</h4>
                ...
                <p className="text-gray-500 mb-8 text-sm">
                  Sistem web kompleks yang dibangun dari nol sesuai kebutuhan.
                </p>
