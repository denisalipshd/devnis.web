  ...
  return (
    <>
      <SEO
        ...
        description="Jasa pembuatan website profesional untuk UMKM, bisnis, sekolah, dan perusahaan."
        canonical="https://devnis-web.vercel.app/"
        keywords="jasa pembuatan website, web developer, website umkm, website sekolah"
      />
      <div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="relative p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  Setelah testing ketat, website Anda mengudara. Kami tetap di sini untuk dukungan teknis jangka
                  panjang.
                </p>
              </div>
            </div>
