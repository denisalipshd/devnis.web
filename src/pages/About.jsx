...
const About = () => {
  return (
    <>
      <SEO
        title="Tentang Kami"
        description="Kenali Devnis Web, penyedia jasa pembuatan website modern dan profesional."
        canonical="https://devnis-web.vercel.app/about"
      />
      <div>
        <header className="pt-48 pb-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-lg md:text-xl max-w-2xl mb-8 mx-auto leading-relaxed">
              ...
              standar. Kami menciptakan pengalaman digital kustom untuk brand yang ingin memimpin, bukan sekadar
              mengikuti tren.
            </p>
          </div>
        </header>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed">
                ...
                kami adalah menciptakan interaksi yang bermakna bagi pengguna melalui produk digital yang indah dan
                cepat.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-500 leading-relaxed">
                Misi kami adalah menyediakan infrastruktur teknis yang dibutuhkan perusahaan untuk berkembang. Kami
                tidak hanya menulis kode; kami merancang solusi yang mendorong pendapatan dan loyalitas pelanggan Anda.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-10 bg-white border border-gray-100 rounded-2xl hover:shadow-2xl hover:shadow-blue-600/5 transition-all duration-500 group">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  Kami mengoptimalkan setiap baris kode untuk memastikan situs Anda dimuat secara instan, meningkatkan
                  SEO dan konversi.
                </p>
              </div>
              ...
              <div className="p-10 bg-white border border-gray-100 rounded-2xl hover:shadow-2xl hover:shadow-blue-600/5 transition-all duration-500 group">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  Kami menerapkan protokol keamanan tingkat tinggi untuk melindungi data bisnis dan privasi pelanggan
